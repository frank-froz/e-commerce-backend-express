-- ===============================
-- ESTRUCTURA COMPLETA DESDE PRISMA SCHEMA
-- Incluye campos: imagen, imagenes, banner
-- ===============================

-- Limpiar schema (CUIDADO: elimina todo)
...
CREATE TABLE stock_producto (
    ...
    fecha_actualizacion TIMESTAMP(6) DEFAULT now(),
    UNIQUE(producto_id)
);
